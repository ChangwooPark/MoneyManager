...
| ⚙️ 더보기 탭 | PIN 변경, 월별 예산 설정(연월 선택기), 카테고리 관리, 언어 설정, LINE 알림 설정 |
| 🌐 다국어 지원 | 한국어 ↔ 일본어 즉시 전환, Firestore에 언어 설정 저장 (재접속 시 유지) |
| 📷 영수증 스캔 | 거래 입력 시 영수증 사진 촬영 → Claude Vision AI가 금액·메모 자동 입력 |
...
**AI**
- Claude Haiku (Anthropic) — 영수증 Vision OCR
